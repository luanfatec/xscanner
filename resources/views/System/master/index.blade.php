...
<body>
    ...
    <div id="content-center-root">

        <header id="header-menu">
            <div class=" bg-xs-dark-color text-white">
              <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                  <a href="{{ route('system.home') }}" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                    <img id="logo" src="{{ asset('assets/images/system/xscanner.png') }}"/>
                  </a>

                  <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">

                    <li>
                        <a href="{{ route('system.home') }}" class="nav-link text-white">
                    ...
                    <li>
                      <a href="{{ route('system.hosts') }}" class="nav-link text-white">
                        <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#server"/></svg>
                        Maquinas
                      </a>
                    </li>
                    ...
                    <li>
                      <a href="{{ route('system.ports') }}" class="nav-link text-white">
                        <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#ethernet"/></svg>
                        Portas
                      </a>
                    </li>

                    <li>
                      <a href="{{ route('system.history') }}" class="nav-link text-white">
